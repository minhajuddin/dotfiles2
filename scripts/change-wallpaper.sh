...
#xloadimage -onroot "/home/minhajuddin/Pictures/green-trees.jpg" &> /dev/null
#exit
...
DISPLAY=:0 xloadimage -onroot "$__WALLPAPERS_DIR/$(ls $__WALLPAPERS_DIR | sed -n "$__WALLPAPERS_INDEX p" )" &> /dev/null
xloadimage -onroot "$__WALLPAPERS_DIR/$(ls $__WALLPAPERS_DIR | sed -n "$__WALLPAPERS_INDEX p" )" &> /dev/null
echo "$__WALLPAPERS_DIR/$(ls $__WALLPAPERS_DIR | sed -n "$__WALLPAPERS_INDEX p" )"
